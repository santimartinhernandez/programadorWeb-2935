...
name1 = prompt('Decime un número')
console.log("Hola " + name1)


number1 = prompt('Decime un número')
var parsedNumber1 = parseFloat(number1, 10)


var resultSum = parsedNumber1 + number2
console.log(resultSum)


number3 = prompt('Decime un número')
var parsedNumber2 = parseFloat(number3, 10)
var resultRes = parsedNumber2 - number4
